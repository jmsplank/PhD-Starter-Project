...
def load_moving(trange, probe, meanv, width=-1, windows=10):
    ...
    fsm_B = data_quants["mms1_fgm_b_gse_brst_l2"].values
    time_dist = data_quants["mms1_fgm_b_gse_brst_l2"].coords["time"].values
...
if __name__ == "__main__":
    ...
    x, out = load_moving(trange, probe, meanv, width=-1, windows=250)
    ...
    if whatToPlot == "data":
        ...
        plt.tight_layout()
        plt.savefig(f"src/quaspara_CS/img/210315_FGM_vsBtot_{scale}")